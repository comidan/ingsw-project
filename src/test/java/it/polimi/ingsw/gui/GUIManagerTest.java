...
public class GUIManagerTest {
    ...
    public void testGUIManager() {
        ...
        assertEquals(gd.getDisplayMode().getHeight() * 0.9, GUIManager.getScreenHeight(), 0);
        ...
        assertEquals(((double)x) * gd.getDisplayMode().getHeight() * 0.9 / 1080, GUIManager.getResizedFont(x), 0);
    }
}
