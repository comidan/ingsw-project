...
public class ObjectiveCardView extends ImageView {
    ...
    public ObjectiveCardView(int id) {
        ...
        this.id = id;
        this.setImage(new Image(new File(OBJECTIVE_IMAGE_ROOT_PATH + Integer.toString(id) + ".jpg").toURI().toString(), resizer.getWidthPixel(15), resizer.getHeightPixel(20), true, false));
